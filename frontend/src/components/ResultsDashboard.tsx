    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="text-center">
            <div className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${getComplexityColor(analysis.executive_summary.implementation_complexity)}`}>
              {analysis.executive_summary.implementation_complexity} Complexity
            </div>
            <div className="text-sm text-gray-600 mt-2">Implementation</div>
          </div>
        </div>
      </div>
      ...
      {/* Task Breakdown */}
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Task Breakdown & Automation Opportunities</h2>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Time Savings</th>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Task Savings Chart */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Annual Savings by Task</h3>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Automation Potential by Task</h3>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
      ...
      {/* Automation Workflow */}
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Automation Workflow</h2>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Current Process</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Automated Process</h3>
            <div className="space-y-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">AI Integration Points</h3>
            <div className="space-y-3">
